...
#define MED2RAW_VER_MINOR	((ui1) 1)
...
si4	main(si4 argc, si1 **argv)
{
	...
	// read session
	flags = LH_READ_SLICE_SEGMENT_DATA_m12 | LH_READ_SLICE_ALL_RECORDS_m12 | LH_NO_CPS_CACHING_m12;  // no caching more efficient for single reads with VDS;
